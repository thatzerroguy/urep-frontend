...
export default function EntrepreneurshipTermsPage() {
    ...
    const handleContinue = () => {
        ...
        router.push('/register?program=entrepreneurship');
    }
        ...
        <div className={'w-screen min-h-screen flex flex-col'}>
            ...
            <div className={'flex-grow flex flex-col items-center w-full px-4 py-8 mb-16'}>
                <h1 className={'font-bold text-3xl my-4 sm:my-8 text-center text-[#277B12]'}>
                    Entrepreneurship Programme for Unemployed Youths Of South-West Geopolitical Zone
                </h1>
